...
| 2026-06-22 | unsourced | no single cell — the routed families disagree, so the venue states no instant | `CME-SVC-2026-06-18` | T2 | interest rates and FX replacement blocks: Saturday 05:00-17:00 CT, the Sunday Pre-Open 16:00-17:00 CT and the Sunday-17:00-to-Monday-16:00 session; no row in energy, equity index, grains or livestock |
