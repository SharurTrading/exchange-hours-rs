...
Hours table, read as bytes and saved. Rows: 32 — 28 `closed`, 4 `early close`,
...
| `modified` `[N3]` — no final close on the date and a 16:00 CT rather than 16:45 CT pre-open, the whole span rolling into the next business day | `closed` |
...
|---|---|---|---|---|---|
| 2025-01-01 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2025-01-01` | T2 | eventDate 2025-01-01, CME trade date 2025-01-02; eventDate 2024-12-31 prints `16:00 closed` for trade date 2024-12-31 with no evening re-open |
| 2025-01-20 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2025-01-20` | T2 | eventDate 2025-01-20, CME trade date 2025-01-21 |
| 2025-02-17 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2025-02-17` | T2 | eventDate 2025-02-17, CME trade date 2025-02-18 |
| 2025-04-18 | closed | `no events published` | `CME-SVC-2025-04-18` | T2 | eventDate 2025-04-18; eventDate 2025-04-17 prints `16:00 closed` for trade date 2025-04-17 with no evening re-open |
| 2025-05-26 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2025-05-26` | T2 | eventDate 2025-05-26, CME trade date 2025-05-27 |
| 2025-06-19 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2025-06-19` | T2 | eventDate 2025-06-19, CME trade date 2025-06-20 |
| 2025-07-04 | early close | `12:00 closed` — 12:00 CT | `CME-SVC-2025-07-04` | T2 | eventDate 2025-07-04, CME trade date 2025-07-04 |
| 2025-09-01 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2025-09-01` | T2 | eventDate 2025-09-01, CME trade date 2025-09-02 |
| 2025-11-27 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2025-11-27` | T2 | eventDate 2025-11-27, CME trade date 2025-11-28 |
| 2025-11-28 | early close | `07:00 preopen; 07:30 open; 13:45 closed` — 13:45 CT | `CME-SVC-2025-11-27` | T2 | eventDate 2025-11-28, CME trade date 2025-11-28 |
| 2025-12-24 | early close | `12:45 closed` — 12:45 CT, no evening re-open | `CME-SVC-2025-12-25` | T2 | eventDate 2025-12-24, CME trade date 2025-12-24 |
| 2025-12-25 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2025-12-25` | T2 | eventDate 2025-12-25, CME trade date 2025-12-26 |
...
- Saturday 2025-11-29 is a sourced closure — the live service publishes a
  ...
  empty — and it keys **no crate row**: the five-day week has no Saturday trade
  date, so the row would change no answer. The date is audited, not unexamined.
...
- **Executable hours — the five-day era's `[N3]` holidays.** On 2025-01-20,
  2025-02-17, 2025-05-26, 2025-06-19, 2025-09-01 and 2025-11-27 CME published no
  final close at all: order matching ran from the previous 17:00 CT straight
  through the holiday, pausing only 16:00–17:00 CT for the pre-open, with every
  event carrying the following business date. The holiday's own trade date
  genuinely does not exist, which is exactly what the `closed` row states — but
  the five-day profile closes over the weekend, so the crate's
  following-business-date roll is short-circuited for that era and the row also
  *deletes* the connected block instead of re-assigning it. `is_open` therefore
  answers false for roughly 23 hours per date that the operator published as
  open. Not representable under the scalar holiday vocabulary while the era's
  profile carries a weekend close. Closing condition: the design memo's block
  rows (#93), or a sourced statement that would let the five-day era roll its business
  date the way the 24/7 era does.
...
- **Residual risk — the pre-finalisation captures.** 2025-01-01, 2025-01-20,
  ...
  pre-holiday publication; CME states on the same page that the schedule is
...
| Trade date | Kind | Instant as printed | Document | Tier | Derived from |
|---|---|---|---|---|---|
| 2026-01-01 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2026-01-01` | T2 | eventDate 2026-01-01, CME trade date 2026-01-02; eventDate 2025-12-31 prints `16:00 closed` for trade date 2025-12-31 with no evening re-open |
| 2026-01-19 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2026-01-19` | T2 | eventDate 2026-01-19, CME trade date 2026-01-20 |
| 2026-02-16 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2026-02-16` | T2 | eventDate 2026-02-16, CME trade date 2026-02-17 |
| 2026-04-03 | early close | `10:15 closed` — 10:15 CT | `CME-SVC-2026-04-03` | T2 | eventDate 2026-04-03, CME trade date 2026-04-03 |
| 2026-05-25 | closed | `16:00 preopen; 17:00 open` — CT; no final close on this date | `CME-SVC-2026-05-25` | T2 | eventDate 2026-05-25, CME trade date 2026-05-26 |
| 2026-06-19 | closed | `16:00 closed /TD 2026-06-22; 16:01 preopen /TD 2026-06-22; 16:02 open /TD 2026-06-22` — CT | `CME-SVC-2026-06-19` | T2 | eventDate 2026-06-19, CME trade date 2026-06-22 |
...
| 2026-09-07 | closed | `16:01 preopen; 16:02 open` — CT; the 16:00 CT final close is omitted | `CME-SVC-2026-09-07` | T2 | eventDate 2026-09-07, CME trade date 2026-09-08 |
| 2026-11-26 | closed | `16:01 preopen; 16:02 open` — CT; the 16:00 CT final close is omitted | `CME-SVC-2026-11-26` | T2 | eventDate 2026-11-26, CME trade date 2026-11-27 |
| 2026-12-25 | closed | `16:00 closed /TD 2026-12-28; 16:01 preopen /TD 2026-12-28; 16:02 open /TD 2026-12-28` — CT | `CME-SVC-2026-12-25` | T2 | eventDate 2026-12-25, CME trade date 2026-12-28 |
...
- **Executable hours — the five-day era's `[N3]` holidays**, as 2025: 2026-01-19,
  2026-02-16 and 2026-05-25. Same mechanism, same closing condition.
...
- **Order entry**, as 2025, on 2026-01-01, 2026-01-19, 2026-02-16 and
  2026-05-25.
- **Tier**, as 2025.
...
| Trade date | Kind | Instant as printed | Document | Tier | Derived from |
|---|---|---|---|---|---|
| 2027-01-01 | closed | `16:00 closed /TD 2027-01-04; 16:01 preopen /TD 2027-01-04; 16:02 open /TD 2027-01-04` — CT | `CME-SVC-2027-01-01` | T2 | eventDate 2027-01-01, CME trade date 2027-01-04 |
| 2027-01-18 | closed | `16:01 preopen; 16:02 open` — CT; the 16:00 CT final close is omitted | `CME-SVC-2027-01-18` | T2 | eventDate 2027-01-18, CME trade date 2027-01-19 |
| 2027-02-15 | closed | `16:01 preopen; 16:02 open` — CT; the 16:00 CT final close is omitted | `CME-SVC-2027-02-15` | T2 | eventDate 2027-02-15, CME trade date 2027-02-16 |
| 2027-03-26 | closed | `16:00 closed /TD 2027-03-29; 16:01 preopen /TD 2027-03-29; 16:02 open /TD 2027-03-29` — CT | `CME-SVC-2027-03-26` | T2 | eventDate 2027-03-26, CME trade date 2027-03-29 |
| 2027-05-31 | closed | `16:01 preopen; 16:02 open` — CT; the 16:00 CT final close is omitted | `CME-SVC-2027-05-31` | T2 | eventDate 2027-05-31, CME trade date 2027-06-01 |
| 2027-06-18 | closed | `16:00 closed /TD 2027-06-21; 16:01 preopen /TD 2027-06-21; 16:02 open /TD 2027-06-21` — CT | `CME-SVC-2027-06-18` | T2 | eventDate 2027-06-18, CME trade date 2027-06-21 |
| 2027-07-05 | closed | `16:01 preopen; 16:02 open` — CT; the 16:00 CT final close is omitted | `CME-SVC-2027-07-05` | T2 | eventDate 2027-07-05, CME trade date 2027-07-06 |
| 2027-09-06 | closed | `16:01 preopen; 16:02 open` — CT; the 16:00 CT final close is omitted | `CME-SVC-2027-09-06` | T2 | eventDate 2027-09-06, CME trade date 2027-09-07 |
| 2027-11-25 | closed | `16:01 preopen; 16:02 open` — CT; the 16:00 CT final close is omitted | `CME-SVC-2027-11-25` | T2 | eventDate 2027-11-25, CME trade date 2027-11-26 |
| 2027-12-24 | closed | `16:00 closed /TD 2027-12-23; 16:01 preopen /TD 2027-12-27; 16:02 open /TD 2027-12-27` — CT, on eventDate 2027-12-23 | `CME-SVC-2027-12-23` | T2 | eventDate 2027-12-23, CME trade date 2027-12-27 — the re-open skips 2027-12-24; the same document prints `no events published` for eventDate 2027-12-24 for the nine other product groups, with no cryptocurrency record because the 24/7 grid never stops |
...
| Document | Service window | Capture or retrieval (UTC) | sha256 |
|---|---|---|---|
| `CME-SVC-2025-01-01` | `[THBP-A]` 2024-12-31 .. 2025-01-02 | captured 2024-12-20T15:53:40Z | `375c70eecd19c5c6204ecb408d1b3210a9da4c9a03b85ef1c7dbbcde1397ab63` |
| `CME-SVC-2025-01-20` | `[THBP-A]` 2025-01-19 .. 2025-01-21 | captured 2024-12-20T15:53:40Z | `4f2ab56af14e7b3a6978e7fa6db8e2cfc63a82d06428cd88844f0e5bcf534f40` |
| `CME-SVC-2025-02-17` | `[THBP-A]` 2025-02-16 .. 2025-02-18 | captured 2024-12-20T15:53:40Z | `5bec2ca6b4999a534e4d9818035aaa18ec8626b6c912cf7e3d2c57015536f2fa` |
| `CME-SVC-2025-04-18` | `[THBP-A]` 2025-04-17 .. 2025-04-19 | captured 2024-12-20T15:53:40Z | `865a1d4f08102e00151bd87ab2b8e8a7720e9203a17aaaba24627ade3ed26e74` |
| `CME-SVC-2025-05-26` | `[THBP-A]` 2025-05-25 .. 2025-05-27 | captured 2024-12-20T15:53:40Z | `5f42869879c826f5949b79236aabb3d26d74e7565d92d7cc5e8784c63973210b` |
| `CME-SVC-2025-06-19` | `[THBP-A]` 2025-06-18 .. 2025-06-20 | captured 2024-12-20T15:53:40Z | `a572706907175776255261103b393493ebdf5a8106ec5374d129145bdf89105e` |
| `CME-SVC-2025-07-04` | `[THBP-A]` 2025-07-03 .. 2025-07-05 | captured 2024-12-20T15:53:40Z | `b80cd4bfed0ae72865bfacc1936e107eb8febfcc94b37fcce1d05505c659147b` |
| `CME-SVC-2025-09-01` | `[THBP-A]` 2025-08-31 .. 2025-09-02 | captured 2024-12-20T15:53:40Z | `e075762ed34a86048d94900e10edba10d95b3d766052908ffbb5133f6b64bab0` |
| `CME-SVC-2025-11-27` | `[THBP-A]` 2025-11-26 .. 2025-11-28 | captured 2026-01-29T01:23:09Z, the latest of 45 captures of this window and two months after the holiday | `6c4c598791058dd9a11aff0ddb072c761a436c6d1054b891def74c6935f020f1` |
| `CME-SVC-2025-12-25` | `[THBP-A]` 2025-12-24 .. 2025-12-26 | captured 2026-01-29T01:21:59Z, re-fetched at 2026-01-29T01:23:09Z and byte-identical | `322a2be989b67f5f4cc0ec12fd63a393383d574badd4aacc87a0c9637533d386` |
| `CME-SVC-2026-01-01` | `[THBP-A]` 2025-12-31 .. 2026-01-02 | captured 2026-06-19T11:41:05Z | `0ed61f8328eda4746265cc8e197f10cd53aec06c2b393927bab27c913993d314` |
| `CME-SVC-2026-01-19` | `[THBP-A]` 2026-01-18 .. 2026-01-20 | captured 2026-06-19T11:41:05Z | `5e3ff08bdc7d07474b96b8dc8c18ed0d5e48d12dc4bcad81a5f68820cb2aa89e` |
| `CME-SVC-2026-02-16` | `[THBP-A]` 2026-02-15 .. 2026-02-17 | captured 2026-06-19T11:41:05Z | `5dd507dd959d0029e838ec88b1bdb63c32444ea36a121de002606f5d7b206e2f` |
| `CME-SVC-2026-04-03` | `[THBP-A]` 2026-04-01 .. 2026-04-03 | captured 2026-06-19T11:41:18Z | `54bcc271e9ba9737a99a2fe608e658de0c657075284d050fbfec4fe1aee2a2a5` |
| `CME-SVC-2026-05-25` | `[THBP-A]` 2026-05-24 .. 2026-05-26 | captured 2026-06-19T11:41:05Z | `f7e30d204ce2cbe08e5f486ded6518f623369159f3a36161288a4708288314da` |
| `CME-SVC-2026-06-19` | `[THBP-A]` 2026-06-18 .. 2026-06-20 | captured 2026-06-19T11:34:04Z; independently reproduced by a live read of 2026-06-17 .. 2026-06-19 on 2026-09-12T08:55:13Z | `97fd5da371309f4486a8fb49ff2105c6c1c2396939ab7c76f1a2a1097b6f015c` |
| `CME-SVC-2026-07-03` | `[THBP-A]` 2026-07-03 .. 2026-07-05 | captured 2026-06-19T11:41:08Z; independently reproduced by a live read of 2026-07-02 .. 2026-07-04 on 2026-09-12T08:55:14Z | `4b89a026358e998277f9c1ff7e095e5d4e625cdc45115fd141dc92201833155b` |
| `CME-SVC-2026-09-07` | `[THBP-A]` 2026-09-06 .. 2026-09-08 | retrieved live 2026-09-12; byte-identical to the archive capture 2026-08-30T14:29:30Z | `01fb78ffaac10eac466fed53674214222f05aed518b9d93a4b42cf8957147bca` |
| `CME-SVC-2026-11-26` | `[THBP-A]` 2026-11-25 .. 2026-11-27 | retrieved live 2026-09-12; byte-identical to the archive capture 2026-08-30T14:29:04Z | `e1f35a5623b3c5d15e7468b2cb4119e587411a9714f920605dab11bf688756d1` |
| `CME-SVC-2026-12-25` | `[THBP-A]` 2026-12-24 .. 2026-12-26 | retrieved live 2026-09-12; byte-identical to the archive capture 2026-08-30T14:29:04Z | `bdc1fe831adb794bcf8aeb7e99baf6af2009d1ff9969d0a48b18b2ebc2e1e829` |
| `CME-SVC-2027-01-01` | `[THBP-A]` 2026-12-31 .. 2027-01-02 | retrieved live 2026-09-12; byte-identical to the archive capture 2026-08-30T14:29:04Z | `7162652821c16f1bd05e3ec533bd5b82af03833c7186a64c7734b0b650364dcd` |
| `CME-SVC-2027-01-18` | `[THBP-A]` 2027-01-17 .. 2027-01-19 | retrieved live 2026-09-12 | `7155c4b7ee8b299b3033eb3daf002b6ceecf0fbd53f6f98a7036048022275743` |
| `CME-SVC-2027-02-15` | `[THBP-A]` 2027-02-14 .. 2027-02-16 | retrieved live 2026-09-12 | `41f5aa8cde3879f8b10490386c134a294a0f1509edde2022a22ec3ffcaed1183` |
| `CME-SVC-2027-03-26` | `[THBP-A]` 2027-03-25 .. 2027-03-27 | retrieved live 2026-09-12 | `9bd7225d440e00139f30892f3914c9b38beb8bf29d4272039b6cd8f2de926880` |
| `CME-SVC-2027-05-31` | `[THBP-A]` 2027-05-30 .. 2027-06-01 | retrieved live 2026-09-12 | `1283649724c30163fa08ba7ab02d1230fa9a7dd0613b8b4b3d96cd1d9dc4febd` |
| `CME-SVC-2027-06-18` | `[THBP-A]` 2027-06-17 .. 2027-06-19 | retrieved live 2026-09-12 | `60c9a2f5106d61039a616986b463cd852861ee4d3b91b11fac8badfa1b97b01c` |
| `CME-SVC-2027-07-05` | `[THBP-A]` 2027-07-04 .. 2027-07-06 | retrieved live 2026-09-12 | `93ff8232886435c94be682bf968aa30749011cdf8dadeb7d2425a3b0b9e0bf71` |
| `CME-SVC-2027-09-06` | `[THBP-A]` 2027-09-05 .. 2027-09-07 | retrieved live 2026-09-12 | `aa08a3bd102812928e69cf1ea4c8a84f738eaa5d14f967acee7d2571e74aedb9` |
| `CME-SVC-2027-11-25` | `[THBP-A]` 2027-11-24 .. 2027-11-26 | retrieved live 2026-09-12 | `6aa7c0fd701a02480dabeac1fbae1a69b56e77643a29e3a9b2223c56e822ce9f` |
| `CME-SVC-2027-12-23` | `[THBP-A]` 2027-12-22 .. 2027-12-25 | retrieved live 2026-09-12 | `5edc4dd588a32faa74f841494c10a3df48692dca29843c3581bad3e18c30fef9` |
