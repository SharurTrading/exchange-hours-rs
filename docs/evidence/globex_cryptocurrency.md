...
**Coverage:** 2022-01-01..2024-12-31, 2025-01-01..2027-12-31 (inclusive venue-local trade dates).

**Two contiguous audited eras.** The table declares 2 coverage windows: `2022-01-01..2024-12-31`, from the 2022 workbooks and 2023 one-pagers at **T1** and CME's service responses at **T2**; and `2025-01-01..2027-12-31`, from the trading-hours service at T2. They are adjacent, so no gap lies between them. Everything before 2022 lies outside every declared window, and `holiday_on` therefore has **no answer** there rather than reporting an unaudited date as normal: 2019-2021 and 2013-2015 are the stage-2.2 waves that never reached this family, the years before its 2017-12-17 launch list no cryptocurrency futures at all, and the eras before 2010 are out of scope below the crate's January-2010 floor. `HolidayCoverage::windows()` lists the 2, and `contains` answers per date.
