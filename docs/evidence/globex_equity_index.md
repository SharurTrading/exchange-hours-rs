...
What each of the non-holiday-window documents in that table is for:

- `CME-SVC-2025-11-26-SAT` — the Thanksgiving 2025 window extended to Saturday 2025-11-29; all ten products publish an empty schedule for the Saturday. Reproduces the three preceding event dates of `CME-SVC-2025-11-26` event for event, and keys this family's 2025-11-29 closure.
- `CME-SVC-2025-11-26-PRE` — the superseded pre-holiday publication of the Thanksgiving 2025 window. Agrees with `CME-SVC-2025-11-26` on every instant and lacks the 2025-11-28 morning pre-open/open pair. Keys no row; retained so the supersession is visible.
- `CME-TRADING-HOURS-2025-08-30` — T1 operator page, 2025 edition. Carries the Central Time statement and the Good Friday 2026 Holiday Note. States no instants, so it corroborates and keys no row.
- `CME-TRADING-HOURS-2026-09-12` — T1 operator page, live. The rendered per-asset-class Holiday Hours table for Thanksgiving 2026 was checked against the service rows row for row.
- `CME-SVC-NORMALWEEK-2026-10-18` — the non-holiday reference week every row's deviation is measured against. Keys no row.
