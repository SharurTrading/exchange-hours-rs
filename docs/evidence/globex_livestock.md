...
|---|---|---|---|---|---|
| 2025-01-01 | closed | `no events published` | `CME-SVC-2025-01-01` | T2 | eventDate 2025-01-01, CME publishes no Livestock trade date; research id D01 |
| 2025-01-20 | closed | `no events published` | `CME-SVC-2025-01-20` | T2 | eventDate 2025-01-20, CME publishes no Livestock trade date; research id D02 |
| 2025-02-17 | closed | `no events published` | `CME-SVC-2025-02-17` | T2 | eventDate 2025-02-17, CME publishes no Livestock trade date; research id D03 |
| 2025-04-18 | closed | `no events published` | `CME-SVC-2025-04-18` | T2 | eventDate 2025-04-18, CME publishes no Livestock trade date; research id D04 |
| 2025-05-26 | closed | `no events published` | `CME-SVC-2025-05-26` | T2 | eventDate 2025-05-26, CME publishes no Livestock trade date; research id D05 |
| 2025-06-19 | closed | `no events published` | `CME-SVC-2025-06-19` | T2 | eventDate 2025-06-19, CME publishes no Livestock trade date; research id D06 |
| 2025-07-04 | closed | `no events published` | `CME-SVC-2025-07-04` | T2 | eventDate 2025-07-04, CME publishes no Livestock trade date; research id D07 |
| 2025-09-01 | closed | `no events published` | `CME-SVC-2025-09-01` | T2 | eventDate 2025-09-01, CME publishes no Livestock trade date; research id D08 |
| 2025-11-27 | closed | `no events published` | `CME-SVC-2025-11-27` | T2 | eventDate 2025-11-27, CME publishes no Livestock trade date; research id D09 |
| 2025-11-28 | early close | `08:00 preopen; 08:30 open; 12:05 closed` — 12:05 CT | `CME-SVC-2025-11-28` | T2 | eventDate 2025-11-28, CME trade date 2025-11-28; research id D09 |
| 2025-11-29 | closed | `no events published` | `CME-SVC-2025-11-29` | T2 | eventDate 2025-11-29 Saturday, CME publishes no Livestock trade date; research id D65 |
...
| 2025-12-25 | closed | `no events published` | `CME-SVC-2025-12-25` | T2 | eventDate 2025-12-25, CME publishes no Livestock trade date; research id D10 |
...
| Trade date | Kind | Instant as printed | Document | Tier | Derived from |
|---|---|---|---|---|---|
| 2026-01-01 | closed | `no events published` | `CME-SVC-2026-01-01` | T2 | eventDate 2026-01-01, CME publishes no Livestock trade date; research id D11 |
| 2026-01-19 | closed | `no events published` | `CME-SVC-2026-01-19` | T2 | eventDate 2026-01-19, CME publishes no Livestock trade date; research id D12 |
| 2026-02-16 | closed | `no events published` | `CME-SVC-2026-02-16` | T2 | eventDate 2026-02-16, CME publishes no Livestock trade date; research id D13 |
| 2026-04-03 | closed | `no events published` | `CME-SVC-2026-04-03` | T2 | eventDate 2026-04-03, CME publishes no Livestock trade date; research id D14 |
| 2026-05-25 | closed | `no events published` | `CME-SVC-2026-05-25` | T2 | eventDate 2026-05-25, CME publishes no Livestock trade date; research id D15 |
| 2026-06-19 | closed | `no events published` | `CME-SVC-2026-06-19` | T2 | eventDate 2026-06-19, CME publishes no Livestock trade date; research id D17 |
...
| 2026-09-07 | closed | `no events published` | `CME-SVC-2026-09-07` | T2 | eventDate 2026-09-07, CME publishes no Livestock trade date; research id D20 |
| 2026-11-26 | closed | `no events published` | `CME-SVC-2026-11-26` | T2 | eventDate 2026-11-26, CME publishes no Livestock trade date; research id D22 |
| 2026-11-27 | early close | `08:00 preopen; 08:30 open; 12:05 closed` — 12:05 CT | `CME-SVC-2026-11-27` | T2 | eventDate 2026-11-27, CME trade date 2026-11-27; research id D22 |
| 2026-12-24 | early close | `08:00 preopen; 08:30 open; 12:05 closed` — 12:05 CT | `CME-SVC-2026-12-24` | T2 | eventDate 2026-12-24, CME trade date 2026-12-24; research id D24 |
| 2026-12-25 | closed | `no events published` | `CME-SVC-2026-12-25` | T2 | eventDate 2026-12-25, CME publishes no Livestock trade date; research id D26 |
...
- The two Thanksgiving-week rows come from one service window: `CME-SVC-2026-11-26` and `CME-SVC-2026-11-27` both resolve to the 2026-11-25 .. 2026-11-27 response. The T1 trading-hours page was captured for this holiday and its printed `Livestock` row matches the service's `LE` row event for event, which is what calibrates the whole T2 block against the operator's own rendering.
- **The two Christmas Eves differ, and are quoted separately.** `CME-SVC-2025-12-24` is `12:15 closed` and `CME-SVC-2026-12-24` is `12:05 closed`, each read from its own response. Neither is derived from the other, and the test asserts both instants independently so a copied row fails.
- `CME-SVC-2026-12-24` resolves to the 2026-12-22 .. 2026-12-24 window and `CME-SVC-2026-12-25` to the overlapping 2026-12-24 .. 2026-12-26 window; the two agree on 2026-12-24 event for event.
...
| Trade date | Kind | Instant as printed | Document | Tier | Derived from |
|---|---|---|---|---|---|
| 2027-01-01 | closed | `no events published` | `CME-SVC-2027-01-01` | T2 | eventDate 2027-01-01, CME publishes no Livestock trade date; research id D29 |
| 2027-01-18 | closed | `no events published` | `CME-SVC-2027-01-18` | T2 | eventDate 2027-01-18, CME publishes no Livestock trade date; research id D30 |
| 2027-02-15 | closed | `no events published` | `CME-SVC-2027-02-15` | T2 | eventDate 2027-02-15, CME publishes no Livestock trade date; research id D32 |
| 2027-03-26 | closed | `no events published` | `CME-SVC-2027-03-26` | T2 | eventDate 2027-03-26, CME publishes no Livestock trade date; research id D34 |
| 2027-05-31 | closed | `no events published` | `CME-SVC-2027-05-31` | T2 | eventDate 2027-05-31, CME publishes no Livestock trade date; research id D36 |
| 2027-06-18 | closed | `no events published` | `CME-SVC-2027-06-18` | T2 | eventDate 2027-06-18, CME publishes no Livestock trade date; research id D38 |
| 2027-07-05 | closed | `no events published` | `CME-SVC-2027-07-05` | T2 | eventDate 2027-07-05, CME publishes no Livestock trade date; research id D40 |
| 2027-09-06 | closed | `no events published` | `CME-SVC-2027-09-06` | T2 | eventDate 2027-09-06, CME publishes no Livestock trade date; research id D42 |
| 2027-11-25 | closed | `no events published` | `CME-SVC-2027-11-25` | T2 | eventDate 2027-11-25, CME publishes no Livestock trade date; research id D44 |
| 2027-11-26 | early close | `08:00 preopen; 08:30 open; 12:05 closed` — 12:05 CT | `CME-SVC-2027-11-26` | T2 | eventDate 2027-11-26, CME trade date 2027-11-26; research id D44 |
| 2027-12-24 | closed | `no events published` | `CME-SVC-2027-12-24` | T2 | eventDate 2027-12-24, CME publishes no Livestock trade date; research id D46 |
...
| Document | Service window | Capture / retrieval UTC | Research store path | sha256 |
|---|---|---|---|---|
| `CME-SVC-2025-01-01` | `fromEventDate=2024-12-31&toEventDate=2025-01-02` | archive capture 2024-12-20T15:53:40Z | `raw/cme-2025-2027/arc/thbp_2024-12-31_2025-01-02_20241220155340.json` | `375c70eecd19c5c6204ecb408d1b3210a9da4c9a03b85ef1c7dbbcde1397ab63` |
| `CME-SVC-2025-01-20` | `fromEventDate=2025-01-19&toEventDate=2025-01-21` | archive capture 2024-12-20T15:53:40Z | `raw/cme-2025-2027/arc/thbp_2025-01-19_2025-01-21_20241220155340.json` | `4f2ab56af14e7b3a6978e7fa6db8e2cfc63a82d06428cd88844f0e5bcf534f40` |
| `CME-SVC-2025-02-17` | `fromEventDate=2025-02-16&toEventDate=2025-02-18` | archive capture 2024-12-20T15:53:40Z | `raw/cme-2025-2027/arc/thbp_2025-02-16_2025-02-18_20241220155340.json` | `5bec2ca6b4999a534e4d9818035aaa18ec8626b6c912cf7e3d2c57015536f2fa` |
| `CME-SVC-2025-04-18` | `fromEventDate=2025-04-17&toEventDate=2025-04-19` | archive capture 2024-12-20T15:53:40Z | `raw/cme-2025-2027/arc/thbp_2025-04-17_2025-04-19_20241220155340.json` | `865a1d4f08102e00151bd87ab2b8e8a7720e9203a17aaaba24627ade3ed26e74` |
| `CME-SVC-2025-05-26` | `fromEventDate=2025-05-25&toEventDate=2025-05-27` | archive capture 2024-12-20T15:53:40Z | `raw/cme-2025-2027/arc/thbp_2025-05-25_2025-05-27_20241220155340.json` | `5f42869879c826f5949b79236aabb3d26d74e7565d92d7cc5e8784c63973210b` |
| `CME-SVC-2025-06-19` | `fromEventDate=2025-06-18&toEventDate=2025-06-20` | archive capture 2024-12-20T15:53:40Z | `raw/cme-2025-2027/arc/thbp_2025-06-18_2025-06-20_20241220155340.json` | `a572706907175776255261103b393493ebdf5a8106ec5374d129145bdf89105e` |
| `CME-SVC-2025-07-04` | `fromEventDate=2025-07-03&toEventDate=2025-07-05` | archive capture 2024-12-20T15:53:40Z | `raw/cme-2025-2027/arc/thbp_2025-07-03_2025-07-05_20241220155340.json` | `b80cd4bfed0ae72865bfacc1936e107eb8febfcc94b37fcce1d05505c659147b` |
| `CME-SVC-2025-09-01` | `fromEventDate=2025-08-31&toEventDate=2025-09-02` | archive capture 2024-12-20T15:53:40Z | `raw/cme-2025-2027/arc/thbp_2025-08-31_2025-09-02_20241220155340.json` | `e075762ed34a86048d94900e10edba10d95b3d766052908ffbb5133f6b64bab0` |
| `CME-SVC-2025-11-27` | `fromEventDate=2025-11-26&toEventDate=2025-11-28` | archive capture 2026-01-29T01:23:09Z | `raw/cme-2025-2027-fix/arc/thbp_2025-11-26_2025-11-28_20260129012309.json` | `6c4c598791058dd9a11aff0ddb072c761a436c6d1054b891def74c6935f020f1` |
| `CME-SVC-2025-11-28` | `fromEventDate=2025-11-26&toEventDate=2025-11-28` | archive capture 2026-01-29T01:23:09Z | `raw/cme-2025-2027-fix/arc/thbp_2025-11-26_2025-11-28_20260129012309.json` | `6c4c598791058dd9a11aff0ddb072c761a436c6d1054b891def74c6935f020f1` |
| `CME-SVC-2025-11-29` | `fromEventDate=2025-11-26&toEventDate=2025-11-29` | live retrieval 2026-09-12T08:55:12Z | `raw/cme-2025-2027-repair/live/probeA_2025-11-26_2025-11-29.md` | `2e9f34f20085de3ccbdff1dc29cb7463bcff93713ef0c550740d6f15e0635ab7` |
| `CME-SVC-2025-12-24` | `fromEventDate=2025-12-24&toEventDate=2025-12-26` | archive capture 2026-01-29T01:21:59Z | `raw/cme-2025-2027/arc/thbp_2025-12-24_2025-12-26_20260129012159.json` | `322a2be989b67f5f4cc0ec12fd63a393383d574badd4aacc87a0c9637533d386` |
| `CME-SVC-2025-12-25` | `fromEventDate=2025-12-24&toEventDate=2025-12-26` | archive capture 2026-01-29T01:21:59Z | `raw/cme-2025-2027/arc/thbp_2025-12-24_2025-12-26_20260129012159.json` | `322a2be989b67f5f4cc0ec12fd63a393383d574badd4aacc87a0c9637533d386` |
| `CME-SVC-2026-01-01` | `fromEventDate=2025-12-31&toEventDate=2026-01-02` | archive capture 2026-06-19T11:41:05Z | `raw/cme-2025-2027/arc/thbp_2025-12-31_2026-01-02_20260619114105.json` | `0ed61f8328eda4746265cc8e197f10cd53aec06c2b393927bab27c913993d314` |
| `CME-SVC-2026-01-19` | `fromEventDate=2026-01-18&toEventDate=2026-01-20` | archive capture 2026-06-19T11:41:05Z | `raw/cme-2025-2027/arc/thbp_2026-01-18_2026-01-20_20260619114105.json` | `5e3ff08bdc7d07474b96b8dc8c18ed0d5e48d12dc4bcad81a5f68820cb2aa89e` |
| `CME-SVC-2026-02-16` | `fromEventDate=2026-02-15&toEventDate=2026-02-17` | archive capture 2026-06-19T11:41:05Z | `raw/cme-2025-2027/arc/thbp_2026-02-15_2026-02-17_20260619114105.json` | `5dd507dd959d0029e838ec88b1bdb63c32444ea36a121de002606f5d7b206e2f` |
| `CME-SVC-2026-04-03` | `fromEventDate=2026-04-01&toEventDate=2026-04-03` | archive capture 2026-06-19T11:41:18Z | `raw/cme-2025-2027/arc/thbp_2026-04-01_2026-04-03_20260619114118.json` | `54bcc271e9ba9737a99a2fe608e658de0c657075284d050fbfec4fe1aee2a2a5` |
| `CME-SVC-2026-05-25` | `fromEventDate=2026-05-24&toEventDate=2026-05-26` | archive capture 2026-06-19T11:41:05Z | `raw/cme-2025-2027/arc/thbp_2026-05-24_2026-05-26_20260619114105.json` | `f7e30d204ce2cbe08e5f486ded6518f623369159f3a36161288a4708288314da` |
| `CME-SVC-2026-06-19` | `fromEventDate=2026-06-18&toEventDate=2026-06-20` | archive capture 2026-06-19T11:34:04Z | `raw/cme-2025-2027/arc/thbp_2026-06-18_2026-06-20_20260619113404.json` | `97fd5da371309f4486a8fb49ff2105c6c1c2396939ab7c76f1a2a1097b6f015c` |
| `CME-SVC-2026-07-03` | `fromEventDate=2026-07-03&toEventDate=2026-07-05` | archive capture 2026-06-19T11:41:08Z | `raw/cme-2025-2027/arc/thbp_2026-07-03_2026-07-05_20260619114108.json` | `4b89a026358e998277f9c1ff7e095e5d4e625cdc45115fd141dc92201833155b` |
| `CME-SVC-2026-09-07` | `fromEventDate=2026-09-06&toEventDate=2026-09-08` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2026-09-06_2026-09-08.json` | `01fb78ffaac10eac466fed53674214222f05aed518b9d93a4b42cf8957147bca` |
| `CME-SVC-2026-11-26` | `fromEventDate=2026-11-25&toEventDate=2026-11-27` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2026-11-25_2026-11-27.json` | `e1f35a5623b3c5d15e7468b2cb4119e587411a9714f920605dab11bf688756d1` |
| `CME-SVC-2026-11-27` | `fromEventDate=2026-11-25&toEventDate=2026-11-27` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2026-11-25_2026-11-27.json` | `e1f35a5623b3c5d15e7468b2cb4119e587411a9714f920605dab11bf688756d1` |
| `CME-SVC-2026-12-24` | `fromEventDate=2026-12-22&toEventDate=2026-12-24` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2026-12-22_2026-12-24.json` | `c8c0267da8cf171409ad8ca188082b3aa326e8d04a89d12503dcf9f57bf3b7ab` |
| `CME-SVC-2026-12-25` | `fromEventDate=2026-12-24&toEventDate=2026-12-26` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2026-12-24_2026-12-26.json` | `bdc1fe831adb794bcf8aeb7e99baf6af2009d1ff9969d0a48b18b2ebc2e1e829` |
| `CME-SVC-2027-01-01` | `fromEventDate=2026-12-31&toEventDate=2027-01-02` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2026-12-31_2027-01-02.json` | `7162652821c16f1bd05e3ec533bd5b82af03833c7186a64c7734b0b650364dcd` |
| `CME-SVC-2027-01-18` | `fromEventDate=2027-01-17&toEventDate=2027-01-19` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2027-01-17_2027-01-19.json` | `7155c4b7ee8b299b3033eb3daf002b6ceecf0fbd53f6f98a7036048022275743` |
| `CME-SVC-2027-02-15` | `fromEventDate=2027-02-14&toEventDate=2027-02-16` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2027-02-14_2027-02-16.json` | `41f5aa8cde3879f8b10490386c134a294a0f1509edde2022a22ec3ffcaed1183` |
| `CME-SVC-2027-03-26` | `fromEventDate=2027-03-25&toEventDate=2027-03-27` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2027-03-25_2027-03-27.json` | `9bd7225d440e00139f30892f3914c9b38beb8bf29d4272039b6cd8f2de926880` |
| `CME-SVC-2027-05-31` | `fromEventDate=2027-05-30&toEventDate=2027-06-01` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2027-05-30_2027-06-01.json` | `1283649724c30163fa08ba7ab02d1230fa9a7dd0613b8b4b3d96cd1d9dc4febd` |
| `CME-SVC-2027-06-18` | `fromEventDate=2027-06-17&toEventDate=2027-06-19` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2027-06-17_2027-06-19.json` | `60c9a2f5106d61039a616986b463cd852861ee4d3b91b11fac8badfa1b97b01c` |
| `CME-SVC-2027-07-05` | `fromEventDate=2027-07-04&toEventDate=2027-07-06` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2027-07-04_2027-07-06.json` | `93ff8232886435c94be682bf968aa30749011cdf8dadeb7d2425a3b0b9e0bf71` |
| `CME-SVC-2027-09-06` | `fromEventDate=2027-09-05&toEventDate=2027-09-07` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2027-09-05_2027-09-07.json` | `aa08a3bd102812928e69cf1ea4c8a84f738eaa5d14f967acee7d2571e74aedb9` |
| `CME-SVC-2027-11-25` | `fromEventDate=2027-11-24&toEventDate=2027-11-26` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2027-11-24_2027-11-26.json` | `6aa7c0fd701a02480dabeac1fbae1a69b56e77643a29e3a9b2223c56e822ce9f` |
| `CME-SVC-2027-11-26` | `fromEventDate=2027-11-24&toEventDate=2027-11-26` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2027-11-24_2027-11-26.json` | `6aa7c0fd701a02480dabeac1fbae1a69b56e77643a29e3a9b2223c56e822ce9f` |
| `CME-SVC-2027-12-24` | `fromEventDate=2027-12-22&toEventDate=2027-12-25` | live retrieval 2026-09-12T04:30Z | `raw/cme-2025-2027/live/thbp/thbp_2027-12-22_2027-12-25.json` | `5edc4dd588a32faa74f841494c10a3df48692dca29843c3581bad3e18c30fef9` |
## Sources
