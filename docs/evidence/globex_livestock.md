...
| 2012-04-05 | early close | `13:55 CT` | `2012-good-friday.pdf @2012-04-17T00:42:47Z` | T1 | `13:55 CT` is the date's own final close; CME prints `Apr 5` above it, and the year comes from the document's own identity |
