...
| 2026-02-17 | replacement blocks | `16:00 preopen /TD 2026-02-17; 17:00 open /TD 2026-02-17` on eventDate 2026-02-15; `12:00 preopen /TD 2026-02-17; 17:00 open /TD 2026-02-17` on eventDate 2026-02-16; `16:00 closed /TD 2026-02-17` on eventDate 2026-02-17 | `CME-SVC-B-2026-02-15` | T2 | the holiday publishes no final close of its own, so the span from Sunday evening through 2026-02-17 16:00 CT carries this trade date. The holiday's Pre-Open is the `12:00` CME prints for `NKD` and `NIY`, not the ordinary weekday `16:45` |
...
| 2026-05-26 | replacement blocks | `16:00 preopen /TD 2026-05-26; 17:00 open /TD 2026-05-26` on eventDate 2026-05-24; `12:00 preopen /TD 2026-05-26; 17:00 open /TD 2026-05-26` on eventDate 2026-05-25; `16:00 closed /TD 2026-05-26` on eventDate 2026-05-26 | `CME-SVC-B-2026-05-24` | T2 | the holiday publishes no final close of its own, so the span from Sunday evening through 2026-05-26 16:00 CT carries this trade date. The holiday's Pre-Open is the `12:00` CME prints for `NKD` and `NIY`, not the ordinary weekday `16:45` |
...
| 2026-07-06 | replacement blocks | `16:45 preopen; 17:00 open` on eventDate 2026-07-02 and `12:00 closed` on eventDate 2026-07-03; `05:00 open; 17:00 closed /TD 2026-07-06` on eventDate 2026-07-04; `16:00 preopen; 17:00 open` on the Sunday — all CME trade date 2026-07-06 (`CME-SVC-B-2026-07-03`); `16:00 closed /TD 2026-07-06` on eventDate 2026-07-06 (`CME-SVC-B-2026-07-05`) | `CME-SVC-B-2026-07-03` | T2 | every phase the operator prints against CME trade date 2026-07-06: the Thursday Pre-Open queue and the session the Friday noon close ends, the Saturday session, the Sunday Pre-Open and the Sunday-17:00-to-Monday-16:00 session. Both `NKD` and `NIY` are read from CME's second product set, which is why the row cites that set's documents |
...
| 2026-09-08 | replacement blocks | `16:00 preopen /TD 2026-09-08; 17:00 open /TD 2026-09-08` on eventDate 2026-09-06; `12:00 preopen /TD 2026-09-08; 17:00 open /TD 2026-09-08` on eventDate 2026-09-07; `16:00 closed /TD 2026-09-08` on eventDate 2026-09-08 | `CME-SVC-B-2026-09-06` | T2 | the holiday publishes no final close of its own, so the span from Sunday evening through 2026-09-08 16:00 CT carries this trade date. The holiday's Pre-Open is the `12:00` CME prints for `NKD` and `NIY`, not the ordinary weekday `16:45` |
...
| 2026-11-27 | replacement blocks | `16:45 preopen /TD 2026-11-27; 17:00 open /TD 2026-11-27` on eventDate 2026-11-25; `12:00 preopen /TD 2026-11-27; 17:00 open /TD 2026-11-27` on eventDate 2026-11-26; `12:15 closed /TD 2026-11-27` on eventDate 2026-11-27 | `CME-SVC-B-2026-11-25` | T2 | Thanksgiving Day publishes no final close of its own, so this trade date owns the span from Wednesday evening and ends at this family's own `12:15` CT close, not the `13:45` the CME equity and energy families use |
...
| 2027-01-19 | replacement blocks | `16:00 preopen /TD 2027-01-19; 17:00 open /TD 2027-01-19` on eventDate 2027-01-17; `12:00 preopen /TD 2027-01-19; 17:00 open /TD 2027-01-19` on eventDate 2027-01-18; `16:00 closed /TD 2027-01-19` on eventDate 2027-01-19 | `CME-SVC-B-2027-01-17` | T2 | the holiday publishes no final close of its own, so the span from Sunday evening through 2027-01-19 16:00 CT carries this trade date. The holiday's Pre-Open is the `12:00` CME prints for `NKD` and `NIY`, not the ordinary weekday `16:45` |
...
| 2027-02-16 | replacement blocks | `16:00 preopen /TD 2027-02-16; 17:00 open /TD 2027-02-16` on eventDate 2027-02-14; `12:00 preopen /TD 2027-02-16; 17:00 open /TD 2027-02-16` on eventDate 2027-02-15; `16:00 closed /TD 2027-02-16` on eventDate 2027-02-16 | `CME-SVC-B-2027-02-14` | T2 | the holiday publishes no final close of its own, so the span from Sunday evening through 2027-02-16 16:00 CT carries this trade date. The holiday's Pre-Open is the `12:00` CME prints for `NKD` and `NIY`, not the ordinary weekday `16:45` |
...
| 2027-06-01 | replacement blocks | `16:00 preopen /TD 2027-06-01; 17:00 open /TD 2027-06-01` on eventDate 2027-05-30; `12:00 preopen /TD 2027-06-01; 17:00 open /TD 2027-06-01` on eventDate 2027-05-31; `16:00 closed /TD 2027-06-01` on eventDate 2027-06-01 | `CME-SVC-B-2027-05-30` | T2 | the holiday publishes no final close of its own, so the span from Sunday evening through 2027-06-01 16:00 CT carries this trade date. The holiday's Pre-Open is the `12:00` CME prints for `NKD` and `NIY`, not the ordinary weekday `16:45` |
...
| 2027-07-06 | replacement blocks | `16:00 preopen /TD 2027-07-06; 17:00 open /TD 2027-07-06` on eventDate 2027-07-04; `12:00 preopen /TD 2027-07-06; 17:00 open /TD 2027-07-06` on eventDate 2027-07-05; `16:00 closed /TD 2027-07-06` on eventDate 2027-07-06 | `CME-SVC-B-2027-07-04` | T2 | the holiday publishes no final close of its own, so the span from Sunday evening through 2027-07-06 16:00 CT carries this trade date. The holiday's Pre-Open is the `12:00` CME prints for `NKD` and `NIY`, not the ordinary weekday `16:45` |
...
| 2027-09-07 | replacement blocks | `16:00 preopen /TD 2027-09-07; 17:00 open /TD 2027-09-07` on eventDate 2027-09-05; `12:00 preopen /TD 2027-09-07; 17:00 open /TD 2027-09-07` on eventDate 2027-09-06; `16:00 closed /TD 2027-09-07` on eventDate 2027-09-07 | `CME-SVC-B-2027-09-05` | T2 | the holiday publishes no final close of its own, so the span from Sunday evening through 2027-09-07 16:00 CT carries this trade date. The holiday's Pre-Open is the `12:00` CME prints for `NKD` and `NIY`, not the ordinary weekday `16:45` |
...
| 2027-11-26 | replacement blocks | `16:45 preopen /TD 2027-11-26; 17:00 open /TD 2027-11-26` on eventDate 2027-11-24; `12:00 preopen /TD 2027-11-26; 17:00 open /TD 2027-11-26` on eventDate 2027-11-25; `12:15 closed /TD 2027-11-26` on eventDate 2027-11-26 | `CME-SVC-B-2027-11-24` | T2 | Thanksgiving Day publishes no final close of its own, so this trade date owns the span from Wednesday evening and ends at this family's own `12:15` CT close, not the `13:45` the CME equity and energy families use |
