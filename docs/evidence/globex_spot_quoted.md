...
- **residual risk, not a gap** — CME's session service is forward-only, so the interior of 2025-06-29 to today cannot be sampled. The negative — a sweep of roughly 1,800 notices from 2025-04-01 to the 2026-09-05 review date returning nine spot-quoted notices, none amending hours — is a search result rather than a statement. Under the carry-back convention no cutover is asserted.
