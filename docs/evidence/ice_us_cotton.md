...
| 2025-11-28 | late open and early close | `Late Open for Cotton - 8:00 am` / `Early Close for Cotton and FCOJ - 1:30 pm` — 08:00 and 13:30 ET | `IFUS-NOTICE-2025-THANKSGIVING` | T1 | revised notice, Fri, Nov 28; Cotton's trading day opens that morning because the prior evening is the Thanksgiving closure |
...
**Gaps, 2025:** **The 2025 Independence Day and Christmas / Boxing Day notices were not retrieved.** Neither is in the Wayback Machine or Common Crawl, 44 live filename candidates returned 404 before the operator's host began rate-limiting, and the notices listing renders client-side so its archived copies name no notice. Their closing condition is page 2+ of the paginated report at <https://www.ice.com/futures-us/notices> (report id `futures_us_exchange_notice`), or the exact PDF URL; tracked as #168. Cotton's calendar column is unaffected — `closed` on 2025-07-04 and 2025-12-25, plain `open` on 2025-12-26 — but those two notices are the only documents that could state a Cotton arrangement on the Monday after Independence Day (2026's notice gives Cotton a late open on 2026-07-06, the Monday after its observed holiday) or on 2025-12-24, so no claim of a *complete* 2025 audit is made for them here. **Canola** and **`Daily Gold and Silver`** are product groups on ICE's calendar with no crate identity in this block. **2025-12-31 is normal, not unsourced:** the 2026 New Year's notice's `Wed, Dec 31` column prints `Regular Hours` for the group that names Cotton No. 2.

**Interpretive steps, 2025:** Cotton shares the softs group line on every 2025 notice and is the only family the revised Thanksgiving notice gives a late open to: `Late Open for Cotton - 8:00 am`. It takes no Easter Monday row — the Good Friday notice names “Sugar No. 11, Coffee “C” and Cocoa” and adds “Regular Hours for all other contracts” — and no London-bank-holiday row, because those notices name the same three softs and state that “All other Exchange products will follow their regular trading schedules”. Cotton is a wrapping contract: the session for trade date D commences 21:00 NY on D-1, so the 2025-11-28 row's late open is the observable deletion of the Thanksgiving-evening leg and its early close ends the Friday session at 13:30.
