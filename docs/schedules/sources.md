...
- **Status:** Nasdaq, Nasdaq Texas/BX, and PSX current and January-2010-or-launch histories are primary-supported within their stated scopes. Nasdaq's encoded 2026-12-06 revision is the announced plan, not an unconditional launch: Equity 1 requires Equity Data Plan readiness and a later Nasdaq readiness filing. Move the revision if that filing changes the launch. The stable `nasdaq_bx` wire name is not renamed with the legal venue.
