...
- **Status:** product specifications control. The seven CME Group key scopes—U.S.-grid equity indexes, CBOT grains/oilseeds, NYMEX energy/PGM plus COMEX metals, major CME FX, CBOT/CME interest rates, CME livestock, and non-spot-quoted cryptocurrency futures—have primary-supported January-2010-or-launch baselines and every modeled normal-week revision. A listing venue is not a venue-wide clock, and product launch eligibility remains instrument-catalog data. The key-backed cryptocurrency calendar joins its one-midnight storage pieces into the sourced continuous weekend bounds and preserves the operator's following-open-business-day convention: normally a Monday trade date and Friday 16:02→Monday 16:00 daily bar, rolling to Tuesday when caller policy closes Monday. It retains Friday 16:00 as the final weekly close. Fixed snapshots retain exact open/closed state but not those identity-dependent bounds, weekly boundaries, or trade dates.
