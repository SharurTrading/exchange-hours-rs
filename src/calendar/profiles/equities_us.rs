...
// Owned-rule builders
//
// Imperative equivalents of the static tables above, for callers that need an
// owned `SessionRule` rather than a borrowed slice. Unreferenced in-crate today.
// -----------------------------------------------------------------------------

#[allow(
    dead_code,
    reason = "owned-rule form of US_EQUITY_REGULAR; no in-crate caller, kept as the builder counterpart"
)]
...
#[allow(
    dead_code,
    reason = "owned-rule form of the US_EQUITY_EXTENDED pre-market slice; no in-crate caller"
)]
...
#[allow(
    dead_code,
    reason = "owned-rule form of the US_EQUITY_EXTENDED post-market slice; no in-crate caller"
)]
