...
// 02:15 CEST. Under the crate convention those first 15 minutes are extended;
// the following continuous interval is regular. The seasonal open remains a
// fixed 00:00 UTC instant. Current Annex C retains the same product grid.
...
static EUREX_PRE_2018_EXTENDED: &[SessionRule] = &[SessionRule {
    days: MON_FRI,
