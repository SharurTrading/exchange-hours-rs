...
pub(crate) static TABLE: &HolidayTable = holidays! {
    ...
    rows: [
        ...
        // 2025-01-02 - T2 - CME-SVC-2025-01-02 - no prior-evening leg; matching opens 08:30 CT.
        (2025, 1, 2, late_open(DAY_OPEN), T2, "CME-SVC-2025-01-02"),
        // 2025-01-20 - T2 - CME-SVC-2025-01-20 - MLK Day, only a 19:00 CT open for trade date 01-21.
        (2025, 1, 20, Closed, T2, "CME-SVC-2025-01-20"),
        // 2025-02-17 - T2 - CME-SVC-2025-02-17 - Presidents' Day, only a 19:00 CT open for 02-18.
        ...
        // 2025-05-26 - T2 - CME-SVC-2025-05-26 - Memorial Day, only a 19:00 CT open for 05-27.
        (2025, 5, 26, Closed, T2, "CME-SVC-2025-05-26"),
        // 2025-06-19 - T2 - CME-SVC-2025-06-19 - Juneteenth, only a 19:00 CT open for 06-20.
        ...
        // 2025-09-01 - T2 - CME-SVC-2025-09-01 - Labor Day, only a 19:00 CT open for 09-02.
        ...
        // 2025-11-28 - T2 - CME-SVC-2025-11-28 - day after Thanksgiving, 08:30-12:05 CT only.
        (
            2025,
            11,
            28,
        ...
        // 2025-12-26 - T2 - CME-SVC-2025-12-26 - no prior-evening leg; matching opens 08:30 CT.
        (2025, 12, 26, late_open(DAY_OPEN), T2, "CME-SVC-2025-12-26"),
        // 2026-01-01 - T2 - CME-SVC-2026-01-01 - New Year's Day, no events published.
        (2026, 1, 1, Closed, T2, "CME-SVC-2026-01-01"),
        // 2026-01-02 - T2 - CME-SVC-2026-01-02 - no prior-evening leg; matching opens 08:30 CT.
        (2026, 1, 2, late_open(DAY_OPEN), T2, "CME-SVC-2026-01-02"),
        // 2026-01-19 - T2 - CME-SVC-2026-01-19 - MLK Day, only a 19:00 CT open for 01-20.
        (2026, 1, 19, Closed, T2, "CME-SVC-2026-01-19"),
        // 2026-02-16 - T2 - CME-SVC-2026-02-16 - Presidents' Day, only a 19:00 CT open for 02-17.
        ...
        // 2026-05-25 - T2 - CME-SVC-2026-05-25 - Memorial Day, only a 19:00 CT open for 05-26.
        ...
        // 2026-09-07 - T2 - CME-SVC-2026-09-07 - Labor Day, only a 19:00 CT open for 09-08.
        ...
        // 2026-11-27 - T2 - CME-SVC-2026-11-27 - day after Thanksgiving, 08:30-12:05 CT only.
        (
            2026,
            11,
            27,
        ...
        // 2027-01-18 - T2 - CME-SVC-2027-01-18 - MLK Day, only a 19:00 CT open for 01-19.
        (2027, 1, 18, Closed, T2, "CME-SVC-2027-01-18"),
        // 2027-02-15 - T2 - CME-SVC-2027-02-15 - Presidents' Day, only a 19:00 CT open for 02-16.
        ...
        // 2027-05-31 - T2 - CME-SVC-2027-05-31 - Memorial Day, only a 19:00 CT open for 06-01.
        (2027, 5, 31, Closed, T2, "CME-SVC-2027-05-31"),
        // 2027-06-18 - T2 - CME-SVC-2027-06-18 - Juneteenth observed, no events published.
        (2027, 6, 18, Closed, T2, "CME-SVC-2027-06-18"),
        // 2027-07-05 - T2 - CME-SVC-2027-07-05 - Independence Day observed, no events published.
        (2027, 7, 5, Closed, T2, "CME-SVC-2027-07-05"),
        // 2027-07-06 - T2 - CME-SVC-2027-07-06 - no prior-evening leg; matching opens 08:30 CT.
        (2027, 7, 6, late_open(DAY_OPEN), T2, "CME-SVC-2027-07-06"),
        // 2027-09-06 - T2 - CME-SVC-2027-09-06 - Labor Day, only a 19:00 CT open for 09-07.
        ...
        // 2027-11-26 - T2 - CME-SVC-2027-11-26 - day after Thanksgiving, 08:30-12:05 CT only.
        (
            2027,
            11,
            26,
        ...
        // 2027-12-24 - T2 - CME-SVC-2027-12-24 - Christmas Friday closure, no events published.
