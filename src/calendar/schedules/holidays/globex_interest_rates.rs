...
pub(crate) static TABLE: &HolidayTable = holidays! {
    ...
    rows: [
        ...
        // 2025-01-20 — T2 — CME-SVC-2025-01-20 — Martin Luther King Jr. Day:
        // matching halts 12:00 CT.
        (2025, 1, 20, early_close(12 * 3_600), T2, "CME-SVC-2025-01-20"),
        // 2025-02-17 — T2 — CME-SVC-2025-02-17 — Presidents' Day: 12:00 CT.
        ...
        // 2025-05-26 — T2 — CME-SVC-2025-05-26 — Memorial Day: 12:00 CT.
        (2025, 5, 26, early_close(12 * 3_600), T2, "CME-SVC-2025-05-26"),
        // 2025-06-19 — T2 — CME-SVC-2025-06-19 — Juneteenth: 12:00 CT.
        ...
        // 2025-09-01 — T2 — CME-SVC-2025-09-01 — Labor Day: 12:00 CT.
        (2025, 9, 1, early_close(12 * 3_600), T2, "CME-SVC-2025-09-01"),
        // 2025-11-27 — T2 — CME-SVC-2025-11-27 — Thanksgiving: 12:00 CT.
        (2025, 11, 27, early_close(12 * 3_600), T2, "CME-SVC-2025-11-27"),
        // 2025-11-28 — T2 — CME-SVC-2025-11-28 — day after Thanksgiving: 12:15 CT
        // final close on its own trade date.
        (2025, 11, 28, early_close(12 * 3_600 + 15 * 60), T2, "CME-SVC-2025-11-28"),
        ...
        // 2026-01-01 — T2 — CME-SVC-2026-01-01 — New Year's Day: only a 16:00 CT
        // pre-open and a 17:00 CT open, both carrying trade date 2026-01-02.
        (2026, 1, 1, Closed, T2, "CME-SVC-2026-01-01"),
        // 2026-01-19 — T2 — CME-SVC-2026-01-19 — Martin Luther King Jr. Day: 12:00 CT.
        (2026, 1, 19, early_close(12 * 3_600), T2, "CME-SVC-2026-01-19"),
        // 2026-02-16 — T2 — CME-SVC-2026-02-16 — Presidents' Day: 12:00 CT.
        (2026, 2, 16, early_close(12 * 3_600), T2, "CME-SVC-2026-02-16"),
        // 2026-04-03 — T2 — CME-SVC-2026-04-03 — Good Friday, the year CME keeps
        // rates trading for the employment release: 10:15 CT final close.
        (2026, 4, 3, early_close(10 * 3_600 + 15 * 60), T2, "CME-SVC-2026-04-03"),
        // 2026-05-25 — T2 — CME-SVC-2026-05-25 — Memorial Day: 12:00 CT.
        (2026, 5, 25, early_close(12 * 3_600), T2, "CME-SVC-2026-05-25"),
        // 2026-06-19 — T2 — CME-SVC-2026-06-19 — Juneteenth: 12:00 CT final close.
        ...
        // 2026-09-07 — T2 — CME-SVC-2026-09-07 — Labor Day: 12:00 CT.
        (2026, 9, 7, early_close(12 * 3_600), T2, "CME-SVC-2026-09-07"),
        // 2026-11-26 — T2 — CME-SVC-2026-11-26 — Thanksgiving: 12:00 CT.
        (2026, 11, 26, early_close(12 * 3_600), T2, "CME-SVC-2026-11-26"),
        // 2026-11-27 — T2 — CME-SVC-2026-11-27 — day after Thanksgiving: 12:15 CT.
        (2026, 11, 27, early_close(12 * 3_600 + 15 * 60), T2, "CME-SVC-2026-11-27"),
        // 2026-12-24 — T2 — CME-SVC-2026-12-24 — Christmas Eve: 12:15 CT final
        // close, and no evening re-open because 2026-12-25 is closed.
        (2026, 12, 24, early_close(12 * 3_600 + 15 * 60), T2, "CME-SVC-2026-12-24"),
        ...
        // 2027-01-18 — T2 — CME-SVC-2027-01-18 — Martin Luther King Jr. Day: 12:00 CT.
        (2027, 1, 18, early_close(12 * 3_600), T2, "CME-SVC-2027-01-18"),
        // 2027-02-15 — T2 — CME-SVC-2027-02-15 — Presidents' Day: 12:00 CT.
        (2027, 2, 15, early_close(12 * 3_600), T2, "CME-SVC-2027-02-15"),
        // 2027-03-26 — T2 — CME-SVC-2027-03-26 — Good Friday: no events published.
        (2027, 3, 26, Closed, T2, "CME-SVC-2027-03-26"),
        // 2027-05-31 — T2 — CME-SVC-2027-05-31 — Memorial Day: 12:00 CT.
        (2027, 5, 31, early_close(12 * 3_600), T2, "CME-SVC-2027-05-31"),
        // 2027-06-18 — T2 — CME-SVC-2027-06-18 — Juneteenth observed: 12:00 CT
        // final close.
        (2027, 6, 18, early_close(12 * 3_600), T2, "CME-SVC-2027-06-18"),
        // 2027-07-05 — T2 — CME-SVC-2027-07-05 — Independence Day observed:
        // matching halts 13:30 CT.
        (2027, 7, 5, early_close(13 * 3_600 + 30 * 60), T2, "CME-SVC-2027-07-05"),
        // 2027-09-06 — T2 — CME-SVC-2027-09-06 — Labor Day: 12:00 CT.
        (2027, 9, 6, early_close(12 * 3_600), T2, "CME-SVC-2027-09-06"),
        // 2027-11-25 — T2 — CME-SVC-2027-11-25 — Thanksgiving: 12:00 CT.
        (2027, 11, 25, early_close(12 * 3_600), T2, "CME-SVC-2027-11-25"),
        // 2027-11-26 — T2 — CME-SVC-2027-11-26 — day after Thanksgiving: 12:15 CT.
        (2027, 11, 26, early_close(12 * 3_600 + 15 * 60), T2, "CME-SVC-2027-11-26"),
        // 2027-12-24 — T2 — CME-SVC-2027-12-24 — Globex closed for the Christmas
