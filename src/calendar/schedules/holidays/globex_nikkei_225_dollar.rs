...
///
/// Three audited eras: 2016-2018 at T1, 2022-2024 at T1 and T2, and 2025-2027
/// at T2, with the 2013-2015 and 2019-2021 intervals audited by no wave and
/// outside every window. No Nikkei table was ever built for 2010-2012, so that
/// era is not a window here. Coverage runs to 2027-12-31, the end of the
...
pub(crate) static TABLE: &HolidayTable = holidays! {
    coverage: [(2016, 1, 1) ..= (2018, 12, 31), (2022, 1, 1) ..= (2024, 12, 31), (2025, 1, 1) ..= (2027, 12, 31)],
    rows: [
