...
///
/// The same rows as [`COMEX`] — seventy-four over two audited eras, thirty-eight
/// from 2010-2012 and thirty-six from 2025-2027 — because the two venues route
/// the same single family: the operator publishes the metals and energy halves
/// as one product row on every date the table audits. They stay separate tables rather than one
