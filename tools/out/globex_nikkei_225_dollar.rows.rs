// globex_nikkei_225_dollar -- venue-local trade dates 2022-01-01 .. 2024-12-31 (LAW-HOLIDAY-SCOPE).
...
// imports: use super::fences::{early_close, late_open, late_open_and_early_close}; use super::{EvidenceTier::{T1, T2}, HolidayKind::{Closed, Unsourced}, HolidayTable, holidays};
        ...
        //   - early close 01:00 CT.
        (2022, 5, 30, early_close(1 * 3_600), T1, "2022-memorial-day-holiday-schedule.xls @2022-07-04T06:54:38Z"),
        ...
        // 2024-01-15 - T2 - CME-SVC-2024-01-14 - unsourced.
        (2024, 1, 15, Unsourced, T2, "CME-SVC-2024-01-14"),
        // 2024-02-19 - T2 - CME-SVC-2024-02-18 - unsourced.
        (2024, 2, 19, Unsourced, T2, "CME-SVC-2024-02-18"),
        // 2024-03-29 - T2 - CME-SVC-2024-03-28 - unsourced.
        (2024, 3, 29, Unsourced, T2, "CME-SVC-2024-03-28"),
        // 2024-05-27 - T2 - CME-SVC-2024-05-26 - unsourced.
        (2024, 5, 27, Unsourced, T2, "CME-SVC-2024-05-26"),
        // 2024-06-19 - T2 - CME-SVC-2024-06-18 - unsourced.
        (2024, 6, 19, Unsourced, T2, "CME-SVC-2024-06-18"),
        // 2024-07-03 - T2 - CME-SVC-2024-07-03 - unsourced.
        (2024, 7, 3, Unsourced, T2, "CME-SVC-2024-07-03"),
        // 2024-07-04 - T2 - CME-SVC-2024-07-03 - unsourced.
        (2024, 7, 4, Unsourced, T2, "CME-SVC-2024-07-03"),
        // 2024-09-02 - T2 - CME-SVC-2024-09-01 - unsourced.
        (2024, 9, 2, Unsourced, T2, "CME-SVC-2024-09-01"),
        // 2024-11-28 - T2 - CME-SVC-2024-11-27 - unsourced.
        (2024, 11, 28, Unsourced, T2, "CME-SVC-2024-11-27"),
        // 2024-11-29 - T2 - CME-SVC-2024-11-27 - unsourced.
        (2024, 11, 29, Unsourced, T2, "CME-SVC-2024-11-27"),
        // 2024-12-24 - T2 - CME-SVC-2024-12-24 - unsourced.
        (2024, 12, 24, Unsourced, T2, "CME-SVC-2024-12-24"),
        // 2024-12-25 - T2 - CME-SVC-2024-12-24 - unsourced.
        (2024, 12, 25, Unsourced, T2, "CME-SVC-2024-12-24"),
        // 2024-12-31 - T2 - CME-SVC-2024-12-31 - unsourced.
        (2024, 12, 31, Unsourced, T2, "CME-SVC-2024-12-31"),
