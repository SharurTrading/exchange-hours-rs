...
Stage-2.2 wave-4 tool (design memo D17), the wave-3 tool re-pointed at the
2019-2021 era. It parses the `holidays!`
...
Usage::
    ...
    python3 tools/venue_intersection_wave4.py                 # the 2019-2021 report
...
def main() -> int:
    ...
    parser.add_argument("--era", nargs=2, type=int, default=[2019, 2021])
